...
public class PreferencesView extends JFrame {
	...
	public PreferencesView(){
		...
		panSelect.setBorder(BorderFactory.createTitledBorder("S�lection des d�s"));
		JRadioButton rbGarde = new JRadioButton();
		rbGarde.setText("Garder les d�s s�lectionn�s");
		rbGarde.setSelected(true);
		JRadioButton rbRelance = new JRadioButton();
		rbRelance.setText("Relancer les d�s s�lectionn�s");
